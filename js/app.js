 ...
 */
    ...
    (() => {
        ...
        function tabs() {
            ...
            function setTitlePosition(tabsMediaArray, matchMedia) {
                tabsMediaArray.forEach((tabsMediaItem => {
                    ...
                    let tabsContent = tabsMediaItem.querySelectorAll("[data-tabs-body]");
        ...
        sidebar.addEventListener("mouseout", (event => {
            if (!event.relatedTarget || !sidebar.contains(event.relatedTarget)) sidebar.classList.remove("_open");
        }));
        ...
        document.addEventListener("click", (function(event) {
            ...
            const isClickInsideUserWrap = userWrap.contains(target);
            if (!isClickInsideDropdown && !isClickInsideUserWrap) {
                dropdown.classList.remove("open");
                userWrap.classList.remove("active");
            }
        }));
        if (userWrap && dropdown) ;
        const inputs = document.querySelectorAll(".form-control__input, .form-control__textarea, .form-control__input-field");
        ...
        function onKeydown(datepicker, ev) {
            ...
            if (key === "ArrowLeft") handleArrowKeyPress(-1, false); else if (key === "ArrowRight") handleArrowKeyPress(1, false); else if (key === "ArrowUp") handleArrowKeyPress(-1, true); else if (key === "ArrowDown") handleArrowKeyPress(1, true); else if (key === "Backspace" || key === "Delete" || key.length === 1 && !ctrlOrMetaKey) datepicker.enterEditMode();
        }
